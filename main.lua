...
if not _G.httpRequest then
    ...
    local v3 = "ArtHub/FishIt" .. "/Position.json";
    local v4 = {
    ...
    TeleportLastPos = function(v61) --[[ Line: 0 ]] --[[ Name:  ]]
        task.spawn(function() --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            if v63 then
                ...
                arthub("Teleported to your last position...");
            end;
        end);
    end;
            ...
            task.spawn(function() --[[ Line: 0 ]] --[[ Name:  ]]
                ...
                if v122 then
                    if v8.curCF then
                        ...
                        task.wait(0.5);
                        v70(v121, true);
                        arthub("Respawn \226\134\146 Back");
    ...
    local v137 = loadstring(game:HttpGet("https://raw.githubusercontent.com/ThisiYann/v2/refs/heads/main/lib.lua"))():Window({
        Title = "ArtHub |", 
    ...
    local v139 = "https://raw.githubusercontent.com/ThisiYann/v2/refs/heads/main/info.lua";
                        ...
                        while v8.supportEnabled do
                            ...
                            if not l_status_5 or not l_result_5 then
                                ...
                                elseif v8.fishingTimer >= (v8.stuckThreshold or 10) then
                                    ...
                                    l_l_v8_3_0 = "255,69,0";
                                    arthub("Fishing Stuck! Resetting...", 3);
    ...
    v228:AddToggle({
        ...
        Callback = function(v254) --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            if v254 then
                ...
                if game.CoreGui:FindFirstChild("ArtX_FishingPanel") then
                    game.CoreGui:FindFirstChild("ArtX_FishingPanel"):Destroy();
                end;
                local l_ScreenGui_0 = Instance.new("ScreenGui");
                l_ScreenGui_0.Name = "ArtX_FishingPanel";
                ...
                v260.Text = "ArtHub PANEL FISHING";
                v260.TextSize = 22;
                ...
                local l_ArtX_FishingPanel_0 = game.CoreGui:FindFirstChild("ArtX_FishingPanel");
                if l_ArtX_FishingPanel_0 then
                    l_ArtX_FishingPanel_0:Destroy();
                end;
            end;
        end
    });
    v228:AddToggle({
        ...
        Callback = function(v281) --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            if v281 then
                if l_CoreGui_0:FindFirstChild("ArtX_BlackScreen") then
                    l_CoreGui_0.ArtX_BlackScreen:Destroy();
                end;
                local l_ScreenGui_1 = Instance.new("ScreenGui");
                l_ScreenGui_1.Name = "ArtX_BlackScreen";
    ...
    v348:AddButton({
        ...
        Callback = function() --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            if v350 then
                ...
                arthub("Position saved successfully!");
            end;
        end, 
        ...
        SubCallback = function() --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            arthub("Last position has been reset.");
        end
    });
    ...
    local function v430(v427) --[[ Line: 0 ]] --[[ Name:  ]]
        ...
        if not v427 then
            ...
            if not l_status_8 then
                warn("[ArtHub] Totem spawn failed:", tostring(l_result_8));
            end;
            return;
        end;
    end;
    ...
    startTradeByName = function() --[[ Line: 0 ]] --[[ Name:  ]]
        ...
        elseif not l_trade_4.selectedPlayer or not l_trade_4.selectedItem then
            return arthub("Select player & item first!");
        else
            l_trade_4.trading = true;
            l_trade_4.successCount = 0;
            arthub("Starting trade with " .. l_trade_4.selectedPlayer);
    ...
    startTradeByCoin = function() --[[ Line: 0 ]] --[[ Name:  ]]
        ...
        elseif not l_trade_5.selectedPlayer or l_trade_5.targetCoins <= 0 then
            return arthub("\226\154\160 Select player & coin target first!");
        else
            ...
            arthub("Starting coin trade with " .. l_trade_5.selectedPlayer);
            ...
            if #v541 == 0 then
                ...
                arthub("\226\154\160 No fishes found in inventory");
                return;
            else
                ...
                if #v548 == 0 then
                    ...
                    if not v0.Players:FindFirstChild(l_trade_5.selectedPlayer) then
                        ...
                        arthub(string.format("Coin trade finished (Target: %d, Received: %d)", l_trade_5.targetCoins, l_trade_5.successCoins));
                        return;
                    end;
                end;
            end;
    ...
    startTradeByRarity = function() --[[ Line: 0 ]] --[[ Name:  ]]
        ...
        elseif not l_trade_7.selectedPlayer or not l_trade_7.selectedRarity then
            return arthub("\226\154\160 Select player & rarity first!");
        else
            l_trade_7.trading = true;
            l_trade_7.successCount = 0;
            arthub("Starting rarity trade (" .. l_trade_7.selectedRarity .. ") with " .. l_trade_7.selectedPlayer);
            ...
            if #v584 == 0 then
                ...
                return arthub("No " .. l_trade_7.selectedRarity .. " fishes found");
            else
                ...
                arthub("Rarity trade finished (" .. l_trade_7.selectedRarity .. ")");
                return;
            end;
        end;
    end;
    ...
    ThresholdSec:AddButton({
        ...
        Callback = function() --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            if l_HumanoidRootPart_5 then
                ...
                arthub("Successfully copied your position to clipboard!");
            end;
        end
    });
    ThresholdSec:AddInput({
    ...
    v228:AddToggle({
        ...
        Callback = function(v729) --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            _G.KaitunPanel = v729;
            if v729 then
                if v0.CoreGui:FindFirstChild("ArtX_KaitunPanel") then
                    v0.CoreGui:FindFirstChild("ArtX_KaitunPanel"):Destroy();
                end;
                local l_ScreenGui_2 = Instance.new("ScreenGui");
                l_ScreenGui_2.Name = "ArtX_KaitunPanel";
                ...
                local l_ArtX_KaitunPanel_0 = v0.CoreGui:FindFirstChild("ArtX_KaitunPanel");
                if l_ArtX_KaitunPanel_0 then
                    l_ArtX_KaitunPanel_0:Destroy();
                end;
            end;
        end
    });
    v228:AddToggle({
        ...
        Callback = function(v811) --[[ Line: 0 ]] --[[ Name:  ]]
            -- upvalues: v0 (ref)
            local l_ArtX_KaitunPanel_1 = v0.CoreGui:FindFirstChild("ArtX_KaitunPanel");
            if l_ArtX_KaitunPanel_1 then
                local v813 = l_ArtX_KaitunPanel_1:FindFirstChild("MainCard") or l_ArtX_KaitunPanel_1:FindFirstChildWhichIsA("Frame");
                if v813 then
    ...
    v958:AddButton({
        ...
        Callback = function() --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            if not l_teleportTarget_0 then
                arthub("Please select a player first!");
                return;
            else
                ...
                if l_FirstChild_4 and l_FirstChild_4.Character and l_FirstChild_4.Character:FindFirstChild("HumanoidRootPart") then
                    ...
                    if v963 then
                        ...
                        arthub("Teleported to " .. l_FirstChild_4.Name);
                    else
                        arthub("Your HumanoidRootPart not found.");
                    end;
                else
                    arthub("Target not found or not loaded.");
                end;
                return;
            end;
        end
    ...
    v964:AddButton({
        ...
        Callback = function() --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            if not l_teleportTarget_1 then
                arthub("Please select a location first!");
                return;
            else
                ...
                if v967 then
                    ...
                    if l_HumanoidRootPart_18 then
                        ...
                        arthub("Teleported to " .. l_teleportTarget_1);
                    end;
                end;
                return;
            end;
                            ...
                            if _G.AntiStaff then
                                for _, v976 in ipairs(game:GetService("Players"):GetPlayers()) do
                                    if v976 ~= game.Players.LocalPlayer and l_v972_0[v976:GetRankInGroup(l_v971_0)] then
                                        game.Players.LocalPlayer:Kick("ArtHub Detected Staff, Automatically Kicked!");
                                        return;
                                    end;
                                end;
                                task.wait(1);
    ...
    do
        ...
        local function v1005() --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            if not l_hideident_0 or not l_hideident_0.overhead or not l_hideident_0.titleLabel then
                ...
                l_hideident_0.titleLabel.Text = "ArtHub";
                ...
                l_hideident_0.header.Text = l_v980_0 ~= "" and l_v980_0 or "ArtHub Rawr";
                                                ...
                                                if l_l_Frame_1_FirstChild_0 then
                                                    ...
                                                    if v1022 and v1022:IsA("ImageButton") and v1022.Visible and l_Inside_0.Visible and l_l_Frame_1_FirstChild_0.Visible and v1022.Active then
                                                        pcall(function() --[[ Line: 0 ]] --[[ Name:  ]]
                                                            ...
                                                            arthub(string.format("Claimed Reward #%d", l_v1018_0));
                                                        end);
                                                        task.wait(0.7);
                                                    end;
                                                end;
                ...
                if not v1066 then
                    ...
                    elseif _G.WebhookNames and #_G.WebhookNames > 0 and not table.find(_G.WebhookNames, v1066.Name) then
                        ...
                        local v1071 = {
                            embeds = {
                                {
                                    title = "ArtHub Webhook | Fish Caught", 
        ...
        Callback = function() --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            if not l_URL_1 or not l_URL_1:match("discord.com/api/webhooks") then
                ...
                task.spawn(function() --[[ Line: 0 ]] --[[ Name:  ]]
                    ...
                    if l_status_16 then
                        arthub("Successfully sent test message!");
                    else
                        arthub("Failed to send webhook:", l_result_16);
                    end;
                end);
                return;
            end;
                    ...
                    local function v1179(v1144, v1145) --[[ Line: 0 ]] --[[ Name:  ]]
                        ...
                        if v1146 == "" then
                            ...
                            local v1178 = {
                                ...
                                embeds = {
                                    {
                                        title = "\227\128\162ArtHub Webhook | Player Info", 
                                        color = 52479, 
                                        fields = {
                                            {
                                    ...
                                    }, 
                                    {
                                        ...
                                        footer = {
                                            text = string.format("ArtHub Auto Sync | Every %dm", _G.WebhookFlags.Stats.Delay or 5), 
                                            icon_url = "https://i.imgur.com/WltO8IG.png"
                                        }, 
                                        timestamp = os.date("!%Y-%m-%dT%H:%M:%S.000Z")
                                    }
    ...
    v1193:AddToggle({
        ...
        Callback = function(v1197) --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            if v1197 and (not _G.DisconnectCustomName or _G.DisconnectCustomName == "") then
                arthub("Invalid! Input Hide Identity first.");
                if _G.WebhookFlags and _G.WebhookFlags.Disconnect then
    ...
    v1211:AddInput({
        ...
        Callback = function(v1213) --[[ Line: 0 ]] --[[ Name:  ]]
            ...
            if v1213 and v1213:match("^https://discord.com/api/webhooks/") then
                ...
                arthub("Server Luck webhook updated!");
            end;
        end
    });
    v1211:AddToggle({
