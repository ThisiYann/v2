return function(Window, Tabs)
    ...
    local InfoSection = Tabs.Info:AddSection("ArtHub Information", true)
...
<b>Use at your own risk!</b>
    ...
    InfoSection:AddParagraph({
        ...
        Content = "Official link discord ArtHub!",
        Icon = "discord",
        ButtonText = "COPY LINK DISCORD",
        ButtonCallback = function()
            if setclipboard then
                setclipboard("https://discord.com/invite/js4nA59uBS")
                arthub("Succesfully copied link!")
            end
        end
    })
    ...
    MiscBooster:AddToggle({
        ...
        Callback = function(value)
            ...
            local ArtUI = coreGui:FindFirstChild("ArtScreen")
            ...
            if value then
                ...
                if ArtUI then ArtUI.DisplayOrder = 10 end
        ...
        Callback = function(state)
            if queue_on_teleport then
                queue_on_teleport(state and [[
                    loadstring(game:HttpGet("https://raw.githubusercontent.com/ThisiYann/v2/refs/heads/main/main.lua"))()
                ]] or "")
            end
        end
    })
